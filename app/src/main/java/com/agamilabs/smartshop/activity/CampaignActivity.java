...
public class CampaignActivity extends AppCompatActivity implements CallBack, View.OnClickListener {
    ...
    private String urlCampaign = "http://192.168.1.105/smartShop/ConvertPHPCampaign.php";
    //private String urlCampaignStatistics = "http://192.168.0.105/smartShop/ConvertPHPCampaignStatistics.php";
    private String urlCampaignStatistics = "http://192.168.1.105/smartShop/campaign_statistics_2.json";
    private String urlCampaignStatusChange = "http://192.168.1.105/android/AgamiLab/smart_shop/campaign_statistics.json";
