...
public class NotificationHelper extends ContextWrapper {
    ...
    public NotificationCompat.Builder getChannelNotification(String notifyUser, String campaignName,Integer SmsID) {
        ...
        // Set pendingintent for user clicking notification, opening home page
         PendingIntent mainActivityIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, NewCampaignActivity.class), PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        PendingIntent cancelScheduleIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, CampaignActivity.class), PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        return new NotificationCompat.Builder(getApplicationContext(), channelID)
                ...
                .setContentTitle("Scheduled SMS to " + campaignName)
                ...
                .addAction(R.mipmap.ic_launcher, "Cancel Schedule",cancelScheduleIntent);
    }
}
